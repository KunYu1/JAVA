...
public class Q3 { 
	...
	public static void main(String[] args) { 
		...
		JButton btn_t1 = new JButton("Solid Line"); 
		JButton btn_t2 = new JButton("Dash-dotted Line");
		...
		btn_t1.addActionListener((e)->panel1.settype(1));
		btn_t2.addActionListener((e)->panel1.settype(2));
		// ...   //... 
